...
import authentification from "../../server/db/middleware/authentification";
...
function CloseProfile() {
    ...
    document.querySelector("#editMode").setAttribute("style", "display: none");
    document
...
export default class ProfilePage extends React.Component {
    ...
    render() {
        return (
            <div
                className={
                    this.props.showProfile ? "modal is-active" : "modal"
                }>
                <div
                    className={"modal-background"}
                    onClick={this.props.handleCloseProfile}
                />
